...
#python3 generate_data.py --n_examples 10000 --dataset_name 1 --n_arrows 1 --dataset arrows --split_data "eval"
#python3 generate_data.py --n_examples 10000 --dataset_name 2 --n_arrows 2 --dataset arrows --split_data "eval"
#python3 generate_data.py --n_examples 10000 --dataset_name 3 --n_arrows 3 --dataset arrows --split_data "eval"
#python3 generate_data.py --n_examples 10000 --dataset_name 5 --n_arrows 5 --dataset arrows --split_data "eval"
#python3 generate_data.py --n_examples 10000 --dataset_name 7 --n_arrows 7 --dataset arrows --split_data "eval"
#python3 generate_data.py --n_examples 10000 --dataset_name 2 --n_arrows 2 --dataset arrows
#python3 generate_data.py --n_examples 10000 --dataset_name 3 --n_arrows 3 --dataset arrows
#python3 generate_data.py --n_examples 10000 --dataset_name 4 --n_arrows 4 --dataset arrows
#python3 generate_data.py --n_examples 10000 --dataset_name 5 --n_arrows 5 --dataset arrows

#python3 generate_data.py --n_examples 20000 --dataset_name 2_3 --n_arrows 2 3 --dataset double_arrows
python3 generate_data.py --n_examples 20000 --dataset_name 3_5 --n_arrows 3 5 --dataset double_arrows
python3 generate_data.py --n_examples 20000 --dataset_name 3_7 --n_arrows 3 7 --dataset double_arrows
