...
dataset_names=("bathtub_0" "bathtub_1" "bathtub_2" "bathtub_3" "bathtub_4" "airplane_0" "bottle_0")
dataset_names=("airplane_0")
dataset="modelnet"
N_list=(5)
extra_dim=100
experiment_id="airplane_no_ae"
latent_dim=2
epochs=1000
optimizer="adamw"
model="resnet"
weightequivariance=1000
save_interval=1
lr=1e-4
batch_size=100
equiv_loss="chamfer"
seeds=(0 42 17 32 56 0 0)
autoencoder="None"
